...
target_link_libraries(absl_essentials INTERFACE
    ...
    imp_absl_int128 imp_absl_bad_any_cast_impl imp_absl_bad_optional_access imp_absl_bad_variant_access
...
target_link_libraries(absl_containers INTERFACE
    LiteRTLM::absl::essentials
    imp_absl_hash imp_absl_city imp_absl_low_level_hash imp_absl_raw_hash_set
    imp_absl_hashtablez_sampler imp_absl_crc32c imp_absl_crc_cord_state
    imp_absl_crc_cpu_detect imp_absl_crc_internal
)
...
target_link_libraries(absl_random INTERFACE
    ...
    imp_absl_random_internal_platform imp_absl_random_internal_pool_urbg
...
target_link_libraries(absl_log INTERFACE
    ...
    imp_absl_die_if_null imp_absl_periodic_sampler
)

# ==============================================================================
# 4. KITCHEN SINK (Use sparingly!)
# ==============================================================================
...
target_link_libraries(absl_libs INTERFACE
  ...
  $<$<CXX_COMPILER_ID:GNU,Clang,AppleClang>:-Wl,--start-group>
    LiteRTLM::absl::essentials
    LiteRTLM::absl::strings
    LiteRTLM::absl::status
    LiteRTLM::absl::sync
    LiteRTLM::absl::containers
    LiteRTLM::absl::random
    LiteRTLM::absl::flags
    LiteRTLM::absl::log
