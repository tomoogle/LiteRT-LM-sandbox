...
add_library(absl_libs INTERFACE GLOBAL)
...
add_library(tflite_libs INTERFACE GLOBAL)
...
# Path not found: /usr/local/code/github/LiteRT-LM/cmake/build/external/flatbuffers/install/lib

# --- GTEST AUTO-GENERATED IMPORTS ---
...
add_library(gtest_libs INTERFACE GLOBAL)
...
# Path not found: /usr/local/code/github/LiteRT-LM/cmake/build/external/litert/install/lib

# --- RE2 AUTO-GENERATED IMPORTS ---
import_static_lib(imp_re2                        "${RE2_LIB_DIR}/libre2.a")

add_library(re2_libs INTERFACE GLOBAL)
target_link_libraries(re2_libs INTERFACE
    imp_re2
)

# --- SENTENCEPIECE AUTO-GENERATED IMPORTS ---
...
add_library(sentencepiece_libs INTERFACE GLOBAL)
target_link_libraries(sentencepiece_libs INTERFACE
    imp_sentencepiece
    imp_sentencepiece_train
)

# --- TOKENIZERS AUTO-GENERATED IMPORTS ---

add_library(tokenizers_libs INTERFACE GLOBAL)
